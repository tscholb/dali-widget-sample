Name:       com.samsung.dali.widget-viewer-template
Summary:    DALi native widget viewer template
Version:    1.0.0
Release:    1
...
%description
DALi native widget viewer template.
Demonstrates how to load and display a widget using WidgetViewManager
...
%define app_root_dir    widget-viewer-template/
...
%defattr(-,root,root,-)
%{app_exe_dir}/widget-viewer-template
