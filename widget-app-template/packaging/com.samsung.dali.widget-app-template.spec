Name:       com.samsung.dali.widget-app-template
Summary:    DALi native widget app template (provider)
Version:    1.0.0
Release:    1
...
%description
DALi native widget app template — widget provider app.
Demonstrates how to create a widget using Dali::WidgetApplication and
...
%define app_root_dir    widget-app-template/
...
# Install widget preview image under shared/res — the widget_service looks up
# preview images at %{app_ro_dir}/shared/res/<filename> (matches NUI convention).
...
%defattr(-,root,root,-)
%{app_exe_dir}/widget-app-template
