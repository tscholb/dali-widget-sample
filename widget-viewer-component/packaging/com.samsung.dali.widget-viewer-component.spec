Name:       com.samsung.dali.widget-viewer-component
Summary:    DALi native widget viewer component
Version:    1.0.0
Release:    1
...
%description
DALi native widget viewer component.
Demonstrates component-based widget viewing using WidgetViewManager
and WidgetView from widget-viewer-dali.
...
%define app_root_dir    widget-viewer-component/
...
%defattr(-,root,root,-)
%{app_exe_dir}/widget-viewer-component
