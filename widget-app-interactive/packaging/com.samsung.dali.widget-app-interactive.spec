Name:       com.samsung.dali.widget-app-interactive
Summary:    DALi native widget app interactive (provider)
Version:    1.0.0
Release:    1
...
%description
DALi native widget app interactive — widget provider app.
Demonstrates touch and wheel event forwarding between a widget viewer
and a widget provider using Dali::WidgetApplication.
...
%define app_root_dir    widget-app-interactive/
...
%defattr(-,root,root,-)
%{app_exe_dir}/widget-app-interactive
